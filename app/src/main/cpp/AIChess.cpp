...
void AIChess::SetChessCP() {
    switch (drc[move]) {
        case 0:
            comp[x[move] - 1][y[move]] = comp[x[move]][y[move]];
            comp[x[move]][y[move]] = 0;
            SetChessKL(x[move] - 1, y[move]);
            break;
        case 1:
            comp[x[move] + 1][y[move]] = comp[x[move]][y[move]];
            comp[x[move]][y[move]] = 0;
            ...
            break;
        case 2:
            comp[x[move]][y[move] - 1] = comp[x[move]][y[move]];
            comp[x[move]][y[move]] = 0;
            SetChessKL(x[move], y[move] - 1);
            break;
        case 3:
            comp[x[move]][y[move] + 1] = comp[x[move]][y[move]];
            comp[x[move]][y[move]] = 0;
...
int AIChess::CalScoreKL(int xx, int yy) {
    ...
    if (sss == killsign[sign - 1][0]) {
        compy[xx][0] = 0;
        score += 50;
    }
    if (sss == killsign[sign - 1][1]) {
        compy[xx][1] = 0;
        score += 50;
    }
    if (sss == killsign[sign - 1][2]) {
        compy[xx][2] = 0;
        score += 50;
    }
    if (sss == killsign[sign - 1][3]) {
        compy[xx][3] = 0;
        score += 50;
    }
    for (i = 0, sss = 0; i < 4; i++)
