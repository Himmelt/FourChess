...
public class PPActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout chessboard = findViewById(R.id.chess_board);
        ...
        ChessImplement();
        //提示
        TextView red_hint = findViewById(R.id.redshow);
        TextView blue_hint = findViewById(R.id.blueshow);
        red_hint.setText("单击悔棋,长按返回!");
        blue_hint.setText("单击悔棋,长按返回!");
        retract = findViewById(R.id.retract);
        retract.setOnLongClickListener(new ImageButton.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Button confirm = findViewById(R.id.blueyes);
                Button reject = findViewById(R.id.blueno);
                TextView show = findViewById(R.id.blueshow);
                show.setText("返回菜单/重新开局");
                confirm.setVisibility(View.VISIBLE);
                reject.setVisibility(View.VISIBLE);
                confirm.setText("返回菜单");
                reject.setText("重新开局");
                long_click = true;
        ...
        restart.setOnLongClickListener(new ImageButton.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Button confirm = findViewById(R.id.redyes);
                Button reject = findViewById(R.id.redno);
                TextView show = findViewById(R.id.redshow);
                show.setText("返回菜单/重新开局");
                confirm.setVisibility(View.VISIBLE);
                reject.setVisibility(View.VISIBLE);
                confirm.setText("返回菜单");
    ...
    public void Bunding() {
        ...
        chess_btn[0][0] = findViewById(R.id.chess00);
        chess_btn[0][1] = findViewById(R.id.chess01);
        chess_btn[0][2] = findViewById(R.id.chess02);
        chess_btn[0][3] = findViewById(R.id.chess03);

        chess_btn[1][0] = findViewById(R.id.chess10);
        chess_btn[1][1] = findViewById(R.id.chess11);
        chess_btn[1][2] = findViewById(R.id.chess12);
        chess_btn[1][3] = findViewById(R.id.chess13);

        chess_btn[2][0] = findViewById(R.id.chess20);
        chess_btn[2][1] = findViewById(R.id.chess21);
        chess_btn[2][2] = findViewById(R.id.chess22);
        chess_btn[2][3] = findViewById(R.id.chess23);

        chess_btn[3][0] = findViewById(R.id.chess30);
        chess_btn[3][1] = findViewById(R.id.chess31);
        chess_btn[3][2] = findViewById(R.id.chess32);
        chess_btn[3][3] = findViewById(R.id.chess33);
    }
    ...
    public void ScreeImplement(Boolean clear) {
        TextView red = findViewById(R.id.redshow);
        TextView blue = findViewById(R.id.blueshow);
        Button blue_confirm = findViewById(R.id.blueyes);
        Button blue_reject = findViewById(R.id.blueno);
        Button red_confirm = findViewById(R.id.redyes);
        Button red_reject = findViewById(R.id.redno);
        if (clear) {
            red.setText("");
            blue.setText("");
            blue_confirm.setText("");
            blue_reject.setText("");
            red_confirm.setText("");
            red_reject.setText("");
            blue_confirm.setVisibility(View.INVISIBLE);
            blue_reject.setVisibility(View.INVISIBLE);
            red_confirm.setVisibility(View.INVISIBLE);
            red_reject.setVisibility(View.INVISIBLE);
            blue_confirm.setClickable(false);
            blue_reject.setClickable(false);
            red_confirm.setClickable(false);
            red_reject.setClickable(false);
            return;
        }
    ...
    public void RedRequest(View v) {
        Button confirm = findViewById(R.id.blueyes);
        Button reject = findViewById(R.id.blueno);
        TextView blueshow = findViewById(R.id.blueshow);
        int i, j, sum = 0;
        if (long_click) {
            return;
        }
    ...
    public void BlueRequest(View v) {
        Button confirm = findViewById(R.id.redyes);
        Button reject = findViewById(R.id.redno);
        TextView redshow = findViewById(R.id.redshow);
        int i, j, sum = 0;
        if (long_click) {
            return;
        }
