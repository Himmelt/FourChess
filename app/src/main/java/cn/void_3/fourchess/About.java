...
public class About extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView view =(WebView)findViewById(R.id.about_page);
        ...
        ImageView anime=(ImageView)findViewById(R.id.imageView);
        AnimationDrawable animationDrawable=(AnimationDrawable)anime.getDrawable();
        animationDrawable.start();
    }

    public void Refresh(View v){
        WebView page=(WebView)findViewById(R.id.about_page);
        page.reload();
    }
