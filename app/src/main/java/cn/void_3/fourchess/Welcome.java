...
public class Welcome extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress_bar=(NumberProgressBar)findViewById(R.id.loading);
        image=(ImageView)findViewById(R.id.welback);
        setBackRand();
    ...
    public void setBackRand(){
        ...
        switch(rand){
            case  1:image.setImageResource(R.drawable.pic01);break;
            case  2:image.setImageResource(R.drawable.pic02);break;
            case  3:image.setImageResource(R.drawable.pic03);break;
            case  4:image.setImageResource(R.drawable.pic04);break;
            case  5:image.setImageResource(R.drawable.pic05);break;
            case  6:image.setImageResource(R.drawable.pic06);break;
            case  7:image.setImageResource(R.drawable.pic07);break;
        }
    }
    //load_thread线程初始化
    public void Loading(){
    ...
    public void saveBitmap(Bitmap bmp)throws IOException {
        String path=getSDPath()+"/Android/data/cn.void_3.fourchess/";
